    ...
    */
    ...
    'connections' => [
        'mongodb' => [
            ...
            'database' => env('MONGODB_DATABASE', 'smail'),
        ],
        'sqlite' => [
            'driver' => 'sqlite',
            'url' => env('DB_URL'),
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '186.237.198.38'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'smail_oficial'),
            'username' => env('DB_USERNAME', 'smail_user'),
            'password' => env('DB_PASSWORD', 'qIZ,_vfFC{Zp*jhV(h'),
